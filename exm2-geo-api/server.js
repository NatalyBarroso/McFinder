...
var httpsServer = https.createServer(credentials, app);
  ...
  mongoose.connect(
    ...
    () => { /** ready to use. The `mongoose.connect()` promise resolves to mongoose instance. */ 
            app.listen(4001, ()=>{
                console.log('Server running on http://192.168.1.74:4001');
            });
            httpsServer.listen(5176, ()=>{
              console.log('Server running on https://192.168.1.74:5176');
            });
             /* app.listen(4001, ()=>{
              console.log('Server running on http://172.18.70.76:4001');
          });
          httpsServer.listen(5176, ()=>{
            console.log('Server running on https://172.18.70.76:5176');
          });  */
    },
